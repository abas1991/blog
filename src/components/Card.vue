<template>
  <div class="card">
    <div>
      <img class="post-img" :src="postImage" :alt="post.title" />

      <span class="title0">{{ post.title }}</span>

      <p :title="post.text" class="text">{{ post.text }}</p>
      <div class="tags">
...
export default {
  ...
  computed: {
    postImage() {
      return this.post.image || require("../assets/placeholder.jpg");
    },
  },
  props: {
    post: {
